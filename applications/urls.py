...
urlpatterns = [
    ...
    url(r'^notification-popup/$', views.PopupNotification.as_view(), name='notification_popup'),
    url(r'^notification-inside-popup/$', views.NotificationInsidePopup.as_view(), name='inside_popup_notification'),
    ...
    url(r'^applications/(?P<pk>\d+)/cancel/$', views.ApplicationCancel.as_view(), name='application_cancel'),
    url(r'^applications/(?P<pk>\d+)/discard/$', views.ApplicationDiscard.as_view(), name='application_discard'),
    ...
    url(r'^applications/(?P<pk>\d+)/comms-view/(?P<comms_id>\d+)/$', views.ApplicationCommsView.as_view(), name='application_comms_view'),
    ...
    url(r'^applications/(?P<pk>\d+)/assign-officer/$', views.ApplicationAssignOfficer.as_view(), name='application_assign_officer'),
    ...
    url(r'^applications/(?P<pk>\d+)/nextaction/(?P<action>\w+)/(?P<actionid>\d+)/$', views.ApplicationAssignNextAction.as_view(), name='application_nextaction'),
    ...
    url(r'^applications/(?P<pk>\d+)/newspaperpublication-table/$', views.NewsPaperPublicationTable.as_view(), name='application_add_newspaperpublication_table'),
    ...
    url(r'^applications/(?P<pk>\d+)/feedbackpublication-table/(?P<action>\w+)/', views.FeedbackTable.as_view(), name='application_feedbackpublication_table'),
    ...
    url(r'^applications/(?P<pk>\d+)/payment-details/$', views.ApplicationBooking.as_view(), name='application_booking'),
    ...
    url(r'^payments/invoice-pdf/(?P<reference>\d+)',views.InvoicePDFView.as_view(), name='payments-invoice-pdf'),
...
#    url(r'^private-media/view/(?P<file_id>\d+)/(?P<app_id>\d+)/(?P<app_type>\d+)/file.(?P<extension>\w\w\w\w)$', views.getAppFile, name='view_private_file2'),
    ...
    url(r'^private-ledger/view/(?P<file_id>\d+)-(\w+).(?P<extension>\w\w\w)$', views.getLedgerAppFile, name='view_private_ledger_file'),
    url(r'^private-ledger/view/(?P<file_id>\d+)-(\w+).(?P<extension>\w\w\w\w)$', views.getLedgerAppFile, name='view_private_ledger_file2'),
    url(r'^payment/success/$', views.BookingSuccessView.as_view(), name='payment_success'),
    ...
    url(r'^compliance/(?P<pk>\d+)/external/update/$', views.ComplianceCompleteExternal.as_view(), name='compliance_approval_update_external'),
    url(r'^compliance/(?P<pk>\d+)/external/view/$', views.ComplianceViewExternal.as_view(), name='compliance_approval_view_external'),
    url(r'^compliance/(?P<pk>\d+)/internal/update/$', views.ComplianceApprovalInternal.as_view(), name='compliance_approval_update_internal'),
    url(r'^compliance/(?P<pk>\d+)/update/$', views.ComplianceComplete.as_view(), name='compliance_condition_update'),
    url(r'^compliance/(?P<pk>\d+)/submit/$', views.ComplianceSubmit.as_view(), name='compliance_condition_submit'),
...
#    url(r'^organisations/(?P<pk>\d+)/address/update/(?P<type>\w+)/$', views.OrganisationAddressCreate.as_view(), name='organisation_address_update'),
    url(r'^organisations/(?P<pk>\d+)/address/update/(?P<org_id>\d+)/$', views.OrganisationAddressUpdate.as_view(), name='organisation_address_change'),
